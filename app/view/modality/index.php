            ...
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row mb-1"><!-- inicio botão nova modalidade-->
                        ...
                        <div class="col-sm-auto">
                            <a href="new.php" class="btn btn-block btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Nova Modalidade</a>
                        </div>
                    </div>
                ...
                <form id="frm">
                    <div class="form-row align-items-center"><!--inicio form de pesquisa-->
                        ...
                        <div class="col-xl-5 col-lg-7 my-1">
                            <input name="modality" type="text" id="modality" autocomplete="off" class="form-control" title="Buscar Por Modalidade" placeholder="Buscar por Modalidades">
                        </div>                                      
                        <div class="col-md-auto col-sm-12 my-1">
